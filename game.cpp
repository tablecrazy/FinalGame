...
namespace Tmpl8
{
	...
	void Game::Tick(float deltaTime)
	{
		...
		buffs[0].Update(screen, BuffType::Health, ninja, 150, 400);
		buffs[1].Update(screen, BuffType::Speed, ninja, 300, 400);
		buffs[2].Update(screen, BuffType::Shield, ninja, 450, 400);
		buffs[3].Update(screen, BuffType::TimeSlow, ninja, 600, 400);
